...
public class Config {
    ...
    public static final String HOST_WEATHER = "https://api.thinkpage.cn/";
    public static final String HOST_WEATHER_IMG = "http://23.105.215.126:3000/api/v1/weather/";
    public static final String HOST_ACFUN = "http://api.aixifan.com/";
    ...
    public static String HOST_MobileAppAcfun="http://mobile.app.acfun.cn/";
    public static String HOST_SearchAppAcfun="http://search.app.acfun.cn/";
    public static String HOST_WebapiAppAcfun="http://webapi.app.acfun.cn/";
}
