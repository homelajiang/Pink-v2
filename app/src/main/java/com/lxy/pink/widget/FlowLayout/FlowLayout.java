package com.lxy.pink.widget.FlowLayout;
...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mHorizontalSpacing = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,mHorizontalSpacing,getResources().getDisplayMetrics());
            mVerticalSpacing = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,mVerticalSpacing,getResources().getDisplayMetrics());
        } finally {
            a.recycle();
        }
    }
